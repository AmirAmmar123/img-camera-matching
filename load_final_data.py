...
class JSONDataProcessor:
    def __init__(self, json_files = JSON_FILES, pnuids = PNUIDS, thresholds = THRESHOLDS):
...
if __name__ == "__main__":
    ...
    processor = JSONDataProcessor(JSON_FILES, DATABASE_PATH, DATABASE_PATH, PNUIDS, THRESHOLDS)
