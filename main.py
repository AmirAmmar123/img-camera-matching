...
class CameraImageMatcher:
    ...
    def parse_arguments():
        ...
        parser.add_argument("--save_to_gaussian", type=str, default='/data-base/results/gussians.json', help="Save the Gaussian results to this directory")
    ...
    def run(self):
        ...
        for i, g in enumerate(gussians, start=1):
            ...
            # Immediately save each result to the json file
            result = g.get_results()
            self.dump_to_json(result, self.save_to_gaussian)
